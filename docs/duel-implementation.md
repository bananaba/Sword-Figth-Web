...
> 마지막 업데이트: 2026-04-29 (Phase 11.6 — audit pass + 신뢰성 패치 (옵티미스틱 desync, server-clock fallback, useFlash brightness jump, RankedQueue 영속화 + 위치 보존 dedupe, UUID roomId, matchmake exponential backoff, GPU dispose, HUD aria-live), 46 worker tests)
>
