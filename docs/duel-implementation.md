...
> 마지막 업데이트: 2026-04-29 (Phase 10 — 디스패처 인프라 + 시간/공간 효과 (hit-stop / KO slow-mo / trauma-driven CA·Vignette / WCAG-안전 flash / nav.vibrate))
>
...
worker/src/            # Cloudflare Worker + Durable Objects 권위 랭크 서버 (Phase 11a)
  ...
  TitleScreen.tsx       # 이름 + 5 세이버 색 프리셋 (Phase 9.5)
  useDuelLoop.ts        # 매치 상태머신, pendingAttack, 가드, 물리 tick — outcome 시 dispatchImpactFx 호출
